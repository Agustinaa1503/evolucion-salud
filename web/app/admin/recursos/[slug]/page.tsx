...
export const metadata: Metadata = { title: 'Assets de producto | BackOffice' };
export const dynamic = 'force-dynamic';

export default async function AdminProductAssetsPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<ButtonLink href="/admin/recursos">← Recursos</ButtonLink>}
      />
        ...
        <div className="grid gap-0 md:grid-cols-2">
          ...
          <div className="p-5 md:border-l md:border-slate-100 dark:md:border-slate-800">
            <dl className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
              ...
              <dd className="font-semibold text-slate-800 dark:text-slate-100">{product.author ?? 'Equipo Evolución Salud'}</dd>
              ...
              <dt className="text-slate-500 dark:text-slate-400">Badge</dt>
              <dd className="font-semibold text-slate-800 dark:text-slate-100">{product.badge ?? '—'}</dd>
