...
export const blogPosts: BlogPost[] = [
  {
    ...
    "title": "Estrés prequirúrgico: cómo preparar tu cuerpo y tu mente antes de una cirugía",
    "excerpt": "La espera previa a una cirugía activa tu sistema de alerta. Te contamos qué pasa en tu cuerpo y qué puedes hacer para llegar más regulado al quirófano.",
    "date": "2026-07-28",
  ...
  },
  {
    ...
    "excerpt": "El estrés no es el enemigo: la carga acumulada sí. Aprende a reconocer el desgaste silencioso de tu cuerpo antes de que se convierta en enfermedad.",
    "date": "2026-07-21",
    "category": "PINE",
    "readTime": "7 min",
    "categories": [
  ...
  },
  {
    ...
    "excerpt": "La melatonina es mucho más que la «hormona del sueño». Te contamos su rol en la recuperación y qué hábitos la protegen.",
    "date": "2026-07-14",
  ...
  },
  {
    ...
    "excerpt": "Luz, comidas, descanso y actividad: tu cuerpo sigue un ritmo de aproximadamente 24 horas. Alinearte con él puede cambiar tu recuperación.",
    "date": "2026-07-07",
  ...
  },
  {
    ...
    "title": "Cirugía despierta: qué es el mapeo cortical y por qué no deberías temerle",
    "excerpt": "La craneotomía con paciente despierto suena aterradora, pero es una de las técnicas más precisas para proteger el cerebro. Te la explicamos simple.",
    "date": "2026-06-30",
  ...
  },
  {
    ...
    "excerpt": "Quien acompaña también acumula carga alostática. Aprende a reconocer las señales y a sostenerte sin culpa.",
    "date": "2026-06-23",
